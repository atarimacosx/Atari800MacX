...
#ifdef D_PATCH
		UI_MENU_CHECK(5, "D: device (hard disk):"),
#endif
...
#endif		
#ifdef D_PATCH
		SetItemChecked(menu_array, 5, Devices_enable_d_patch);
#endif
...
#ifdef D_PATCH
		case 5:
			Devices_enable_d_patch = !Devices_enable_d_patch;
			break;
#endif
		case 6:
...
static void AboutEmulator(void)
{
	UI_driver->fInfoScreen("About the Emulator",
		"Atari800MacOSX Version 5.1.0 based on\0"						   
