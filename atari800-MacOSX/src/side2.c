...
static int Block_Device;
static int IDE_Enabled;
static int IDE_Removed;
static int IDE_Reset;
static int SDX_Bank_Register;
static int SDX_Enabled;
static int Top_Bank_Register;
static int Top_Enable;
static int Top_Left_Enable;
static int Top_Right_Enable;
