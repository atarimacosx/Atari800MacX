...
#else
static char xld_d_rom_filename[FILENAME_MAX] = "/Users/markg/Atari800MacX/atari800-MacOSX-4.0/src/Atari800MacX/build/Development/OSRoms/dcnt10.bin";
static char xld_v_rom_filename[FILENAME_MAX] = "/Users/markg/Atari800MacX/atari800-MacOSX-4.0/src/Atari800MacX/build/Development/OSRoms/1400.rom";
#endif
...
#ifdef MACOSX
int xld_v_enabled = FALSE;
int xld_d_enabled = FALSE;
#else
