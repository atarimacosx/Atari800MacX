...
@interface SDLAtari800_QuartzWindow : NSWindow
{}
...
@implementation SDLAtari800_QuartzWindow
...
@interface SDLAtari800_QuartzWindowDelegate : NSObject
{}
- (BOOL)windowShouldClose:(id)sender;
@end

@implementation SDLAtari800_QuartzWindowDelegate
- (BOOL)windowShouldClose:(id)sender
{
    SDL_PrivateQuit();
    return NO;
...
@interface SDLAtari800_QuartzWindowView : NSQuickDrawView
{}
@end

@implementation SDLAtari800_QuartzWindowView
@end
