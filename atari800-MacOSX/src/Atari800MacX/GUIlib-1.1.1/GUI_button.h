...
public:
	...
	/* Passed the button data, position, width, height, a caption, a font,
	   ...
	   the callback, the foreground and background colors
	    and a flag if it should be 2D (1) or 3D (0) */
...
protected:
	...
	// Button face color
	Uint8 BF_R,BF_G,BF_B;
	// Button light color
	Uint8 BL_R,BL_G,BL_B;
	// Button shadow color
	Uint8 BS_R,BS_G,BS_B;
	// Button text color
	Uint8 BT_R,BT_G,BT_B;
